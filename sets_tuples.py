...
# #print(set1[0]) # Error 'set' objext does not support indexing
# for element in set1:
#     print(element)
# print(1 in set1)
# print(6 in set1)
...
# set1.remove(3)        #remove and  discrad have the same function
# print(set1)
# set2.discard("banana")
# print(set2)
...
# print(3 in set1) # output = false since 3 was removed earlier
...
# set1.clear()
# print(set1)
# id_numbers = {93939, 38947, 476384, 347384, 34768}

# #remove first element from a set
# id_numbers.pop()
# print(id_numbers)
# #sets do not print in order of insertion
# #add more number and print
# id_numbers.add(48584)
# id_numbers.add(6857634)
# id_numbers.add(4546454)
# id_numbers.add(78857634)
# print(id_numbers)   # prints in random order



#tuples##################################
# Tuples are ordered collections of elements
# Tuples are immutable # you can add/remove values but you cant change the original values
